...
namespace Warehouse.Models
{
    public class Functions
    {
        ...
        readonly static string APIKeyFootball = ConfigurationManager.AppSettings["APIKeyFootball"].ToString();
        readonly static string API_TeamInfo = ConfigurationManager.AppSettings["API_TeamInfo"].ToString();
        ...
        public static List<dynamic> GetFullTeam(int league_id, long match_hometeam_id, long match_awayteam_id)
        {
            List<dynamic> teams = API.GetListAPI<dynamic>(API_TeamInfo + "&league_id=" + league_id + "&APIkey=" + APIKeyFootball);
            dynamic hometeam = teams.FirstOrDefault(x => x.team_key == match_hometeam_id);
            dynamic awayteam = teams.FirstOrDefault(x => x.team_key == match_awayteam_id);
        ...
        public static void UpLoadImage(string fileName, HttpPostedFileBase file, ModelStateDictionary ModelState, string ErrorKey)
        {
            ...
            if (ImageExtensions.Contains(extend.ToLower()) == false)
            {
